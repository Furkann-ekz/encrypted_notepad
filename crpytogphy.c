...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/26 11:45:45 by fekiz             #+#    #+#             */
/*   Updated: 2023/12/28 09:48:24 by fekiz            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned char	ft_bcryptor(unsigned char c)
{
	g_i = 0;
	g_character = 0;
	while (g_i < 7)
...
unsigned char	ft_dcrpytor(unsigned char c)
{
	g_i = 0;
	g_character = 0;
	while (g_i < 4)
...
unsigned char	ft_tcryptor(unsigned char c)
{
	g_i = 0;
	g_character = 0;
	while (g_i < 7)
